...
do
    ...
    # Run simulation
<<<<<<< HEAD
    mpirun -np 8 --report-bindings ./miniMD_openmpi -i in.lj.miniMD >> $LOG_FILE 2>&1
=======
    $EXEC_WRAPPER mpirun -np 8 --map-by core --bind-to core --report-bindings ./miniMD_openmpi -i in.lj.miniMD --ckpt 200 >> $LOG_FILE 2>&1
