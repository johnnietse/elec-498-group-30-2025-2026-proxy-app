...
# Configuration
CSV_FILE="4_cores_simulation_results_${SLURM_JOB_ID:-manual}.csv"
...
do
    ...
    # Run simulation
<<<<<<< HEAD
    mpirun -np 4 --report-bindings ./miniMD_openmpi -i in.lj.miniMD >> $LOG_FILE 2>&1
=======
    $EXEC_WRAPPER mpirun -np 4 --map-by core --bind-to core --report-bindings ./miniMD_openmpi -i in.lj.miniMD --ckpt 200 >> $LOG_FILE 2>&1
