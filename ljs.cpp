...
int main(int argc, char** argv)
{
  ...
  for(int i = 0; i < argc; i++) {
    ...
    if((strcmp(argv[i], "-h") == 0) || (strcmp(argv[i], "--help") == 0)) {
      ...
      printf("\t--ckpt_io_duration <SEC>:     I/O duration in seconds (default: 30)\n");
      printf("\t--ckpt_chunk_mb <MB>:         chunk size in MB (default: 1)\n");
      printf("\t--ckpt_sleep_ms <MS>:         sleep between chunks in ms (default: 100)\n");
      ...
      printf("\t  mpirun -np 4 ./miniMD --ckpt_io_duration 60 --ckpt_chunk_mb 2 --ckpt_sleep_ms 50\n\n");
      printf("\t# Fast I/O (10 seconds, 5MB chunks, no sleep):\n");
      printf("\t  mpirun -np 4 ./miniMD --ckpt_io_duration 10 --ckpt_chunk_mb 5 --ckpt_sleep_ms 0\n\n");
